...
public class EmployeeServiceImpl implements EmployeeService{
	...
	public boolean addEmployee(EmployeeBean bean) {
		if (bean.getName()==null||bean.getEmail()==null||bean.getPassword()==null) {
			return false;
	...
	public boolean modifyEmployee(EmployeeBean bean) {
		if (bean.getName()==null||bean.getEmail()==null||bean.getPassword()==null) { //can use isEmpty() method instead
			return false;
		}else if(bean.getPassword().length()<5){
			return false;
		}
